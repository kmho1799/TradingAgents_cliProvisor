...
class TradingAgentsGraph:
    ...
    def _get_provider_kwargs(self) -> Dict[str, Any]:
        ...
        if provider == "google":
            ...
            kwargs["ai_runtime_enable_web"] = self.config.get(
                "ai_runtime_enable_web", False
            )
            kwargs["ai_runtime_timeout_seconds"] = self.config.get(
                "ai_runtime_timeout_seconds", 600
            )
            kwargs["ai_runtime_fallback_mode"] = self.config.get(
                "ai_runtime_fallback_mode", "none"
            )
            kwargs["ai_runtime_fallback_backend"] = self.config.get(
                "ai_runtime_fallback_backend"
            )
            kwargs["ai_runtime_fallback_model"] = self.config.get(
                "ai_runtime_fallback_model"
            )
            kwargs["ai_runtime_strict_backend"] = self.config.get(
